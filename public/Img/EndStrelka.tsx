...
// Компонент EndStrel1 отображает SVG иконку.
// Пропсы:
// - className: строка, дополнительный класс для SVG элемента.
// - width: ширина SVG иконки.
// - height: высота SVG иконки.
// - fillColor: цвет заливки SVG иконки.
const EndStrel1 = ({ className = '', width = '20px', height = '20px', fillColor = "#ffffff" }) => {
    return (
        <svg
            className={`EndStrel1 ${className}`} // Добавление префикса для класса для удобства стилизации
            width={width}
            height={height}
            viewBox="0  0  15  14" // Удаление лишних пробелов
            fill="none"
